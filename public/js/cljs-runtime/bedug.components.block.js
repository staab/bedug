...
bedug.components.block.block_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"shake","shake",1292044195),(function (_){
return "bedug-block bedug-block-orange";
}));
bedug.components.block.block_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-blue","turn-blue",-1281000077),(function (_){
return "bedug-block bedug-block-orange";
}));
bedug.components.block.block_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-red","turn-red",68429672),(function (_){
return "bedug-block bedug-block-orange";
}));
bedug.components.block.block_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-green","turn-green",879269205),(function (_){
return "bedug-block bedug-block-orange";
}));
...
bedug.components.block.icon_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"shake","shake",1292044195),(function (_){
return "fa fa-2x fa-atom";
}));
bedug.components.block.icon_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-blue","turn-blue",-1281000077),(function (_){
return "fa fa-2x fa-fill-drip text-blue";
}));
bedug.components.block.icon_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-red","turn-red",68429672),(function (_){
return "fa fa-2x fa-fill-drip text-red";
}));
bedug.components.block.icon_class.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"turn-green","turn-green",879269205),(function (_){
return "fa fa-2x fa-fill-drip text-green";
}));
...
return bedug.state.update_player_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.conj,command], 0));
})], null)], null);
});

//# sourceMappingURL=bedug.components.block.js.map

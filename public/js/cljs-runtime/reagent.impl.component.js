...
if((i < len)){
var k = (ks[i]);
var G__20583 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__20584 = (i + (1));
m = G__20583;
i = G__20584;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__20585 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__20585);
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__20587 = c;
var G__20587__$1 = (((G__20587 == null))?null:G__20587.prototype);
if((G__20587__$1 == null)){
return null;
} else {
return (G__20587__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__20589 = c;
var G__20589__$1 = (((G__20589 == null))?null:G__20589.prototype);
if((G__20589__$1 == null)){
return null;
} else {
return (G__20589__$1["render"]);
}
})() == null))));
});
...
var G__20591 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__20591) : reagent.impl.component.as_element.call(null,G__20591));
};
...
var _STAR_current_component_STAR_20597 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_20597;
}});
...
var G__20598 = key;
var G__20598__$1 = (((G__20598 instanceof cljs.core.Keyword))?G__20598.fqn:null);
switch (G__20598__$1) {
...
return ((function (G__20598,G__20598__$1){
...
var c = this;
var G__20603_20605 = (c["cljsRatom"]);
if((G__20603_20605 == null)){
} else {
reagent.ratom.dispose_BANG_(G__20603_20605);
}
...
var renders_20607 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_20608 = cljs.core.first(cljs.core.vals(renders_20607));
if((cljs.core.count(renders_20607) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_20607))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_20608)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_20608], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__20606 = name;
switch (G__20606) {
case "":
...
var G__20611 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__20611);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__20612 = fiber;
var G__20612__$1 = (((G__20612 == null))?null:(G__20612["type"]));
if((G__20612__$1 == null)){
return null;
} else {
return (G__20612__$1["displayName"]);
}
})();
var parent = (function (){var G__20613 = fiber;
if((G__20613 == null)){
return null;
} else {
return (G__20613["return"]);
}
})();
var path = (function (){var G__20614 = parent;
var G__20614__$1 = (((G__20614 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__20614) : reagent.impl.component.fiber_component_path.call(null,G__20614)));
if((G__20614__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20614__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__20616 = c;
if((G__20616 == null)){
return null;
} else {
return (G__20616["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__20617._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__20619 = c;
if((G__20619 == null)){
return null;
} else {
return (G__20619["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__20621 = c;
if((G__20621 == null)){
return null;
} else {
return G__20621._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__20623 = instance;
if((G__20623 == null)){
return null;
} else {
return (G__20623["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__20624 = instance;
if((G__20624 == null)){
return null;
} else {
return G__20624._currentElement;
}
}
})();
var name = (function (){var G__20625 = elem;
var G__20625__$1 = (((G__20625 == null))?null:(G__20625["type"]));
if((G__20625__$1 == null)){
return null;
} else {
return (G__20625__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__20627 = elem;
if((G__20627 == null)){
return null;
} else {
return (G__20627["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__20628._owner;
}
}
})();
var path = (function (){var G__20629 = owner;
var G__20629__$1 = (((G__20629 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__20629) : reagent.impl.component.component_path.call(null,G__20629)));
if((G__20629__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20629__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__20630 = c;
var G__20630__$1 = (((G__20630 == null))?null:G__20630.constructor);
if((G__20630__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__20630__$1);
}
}
})();

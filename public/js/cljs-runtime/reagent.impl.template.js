...
var G__20631 = o;
(G__20631[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__20635 = o;
(G__20635[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__20637__i < G__20637__a.length) {G__20637__a[G__20637__i] = arguments[G__20637__i + 0]; ++G__20637__i;}
  args = new cljs.core.IndexedSeq(G__20637__a,0,null);
} 
...
var args = cljs.core.seq(arglist__20638);
...
var G__20640 = props;
var G__20640__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20640,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20640);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20640__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__20641){
...
var props = map__20642__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20642__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__20642,map__20642__$1,props,class$){
return (function (c){
...
});})(map__20642,map__20642__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__20644){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20645__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__20645,map__20645__$1,on_write){
return (function (){
...
});})(node_value,map__20645,map__20645__$1,on_write))
);
} else {
...
var G__20648 = jsprops;
(G__20648["defaultValue"] = value);

(G__20648["onChange"] = ((function (G__20648,v,value,on_change){
return (function (p1__20647_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__20647_SHARP_);
});})(G__20648,v,value,on_change))
);
...
var vec__20651 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20651,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20651,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20651,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___20655 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___20655 == null)){
} else {
var key_20656 = temp__5461__auto___20655;
(jsprops["key"] = key_20656);
}
...
var temp__5461__auto___20657 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___20657 == null)){
} else {
var key_20658 = temp__5461__auto___20657;
reagent.impl.template.oset(jsprops,"key",key_20658);
}
...
var G__20659 = reagent.impl.template.__GT_NativeWrapper();
(G__20659["name"] = c);
...
var G__20660 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__20660) : reagent.impl.template.as_element.call(null,G__20660));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20663){
var G__20664 = cljs.core.first(seq20663);
var seq20663__$1 = cljs.core.next(seq20663);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20664,seq20663__$1);
});
...
break;
default:
var G__20670 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__20670;
continue;
...
var n__4408__auto___20672 = a.length;
var i_20673 = (0);
while(true){
if((i_20673 < n__4408__auto___20672)){
(a[i_20673] = reagent.impl.template.as_element((a[i_20673])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___20675 = a.length;
var i_20676 = (0);
while(true){
if((i_20676 < n__4408__auto___20675)){
var val_20677 = (a[i_20676]);
if(((cljs.core.vector_QMARK_(val_20677)) && ((reagent.impl.template.key_from_vec(val_20677) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20676] = reagent.impl.template.as_element(val_20677));

var G__20678 = (i_20676 + (1));
i_20676 = G__20678;
continue;
} else {
}
...
var ctx = ({});
var vec__20679 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20679,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20679,(1),null);
...
var G__20682 = (cljs.core.count(argv) - first_child);
switch (G__20682) {
case (0):
...
case (1):
var G__20683 = comp;
var G__20684 = jsprops;
var G__20685 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__20683,G__20684,G__20685);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__20682){
